...
- **Phase D3** — Security Hardening: secure cookie, scope normalization, inline JS escaping, Docker workspace fix. (Previously D4; D2c absorbed the /edit work.)
...
- **Phase D6** — Multi-Household Scalability: onboarding flow, per-household data isolation audit, per-space rate limiting + cost caps.
