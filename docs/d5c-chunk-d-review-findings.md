...
| D2 | `core/src/gui/routes/llm-usage.ts` (parseUsageMarkdown) | Remove `.filter(Boolean)` column-shift | ✓ Done — `4869791` |
| D3 | `core/src/services/metrics/message-rate-tracker.ts:11` | Import `PLATFORM_SYSTEM_HOUSEHOLD_ID` from auth-actor | ✓ Done — `4869791` |
