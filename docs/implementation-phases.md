...
## Archived from CLAUDE.md (2026-05-15)

The following Previous Priority blocks moved here from CLAUDE.md during a slimming pass. Content is reproduced verbatim; check git history on the originating files for the canonical record.
