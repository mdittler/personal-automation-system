...
- ~~**Hermes P5 — SQLite + FTS5 transcript search**~~ ✓ In progress (2026-04-28) — Full-text search across session transcripts via derived SQLite + FTS5 index. LLM recall classifier + auto-injection into Layer 4 fenced context. Rebuild CLI + opt-in retention. REQ-CONV-SEARCH-001..014. Spec: `docs/superpowers/specs/2026-04-28-hermes-p5-transcript-search-design.md`.
