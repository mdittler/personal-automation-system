...
- **Hermes P9 — Photo Memory Bridge**: Photo handlers now return `photoSummary`; router appends to session transcript; `formatConversationHistory` exempts photo-summary turns from truncation; chatbot prompt updated. Receipt integrity: `isValidReceiptDate`, `capturedAt` sort authority. Branch: `codex/hermes-p9-photo-memory-bridge`. See `docs/superpowers/plans/2026-04-29-hermes-p9-photo-memory-bridge.md`.
