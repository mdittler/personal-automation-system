...
Examples: `app:hearthstone:toggle:3`, `app:hearthstone:refresh`, `app:hearthstone:clear`
...
Storage: `grocery/active.yaml` in shared scope (`data/users/shared/hearthstone/grocery/active.yaml`).
...
### Hearthstone App (apps/hearthstone/)
| File | Purpose |
|------|---------|
...
|--------------|--------|
| `app:hearthstone:toggle:<index>` | Toggle purchased on grocery item |
| `app:hearthstone:refresh` | Re-render grocery list |
| `app:hearthstone:clear` | Clear purchased items |
| `app:hearthstone:pantry-all` | Add all purchased items to pantry |
| `app:hearthstone:pantry-skip` | Skip pantry addition |
| `app:hearthstone:staple-add:<name>` | Add excluded staple to grocery list |
| `app:hearthstone:staple-all` | Add all excluded staples |
| `app:hearthstone:exclude-add:<name>` | Add excluded pantry item to grocery |
