# Hearthstone H5a: Cook Mode State Machine + Recipe Scaling
...
Added to `apps/hearthstone/src/types.ts`:
...
| Button | Data (after `app:hearthstone:` stripped) | Wire bytes |
|--------|------------------------------------------|------------|
| < Back | `ck:b` | 21 |
| Repeat | `ck:r` | 21 |
| Next > | `ck:n` | 21 |
...
2. Run new tests: `pnpm test apps/hearthstone/src/__tests__/recipe-scaler.test.ts`
3. Run new tests: `pnpm test apps/hearthstone/src/__tests__/cook-session.test.ts`
4. Run new tests: `pnpm test apps/hearthstone/src/__tests__/cook-mode-handler.test.ts`
