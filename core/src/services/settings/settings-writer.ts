...
import { type CoerceResult, coerceUserConfigValue } from '../config/coerce-user-config.js';
...
export type WriteResult = { ok: true; coerced: unknown } | { ok: false; reason: string };
