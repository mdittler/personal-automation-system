...
describe('estimateGroceryListCost', () => {
	const groceryItems: GroceryItem[] = [
		{ name: 'AP Flour', quantity: 1, unit: 'bag', department: 'Pantry', recipeIds: ['recipe-1'], purchased: false, addedBy: 'system' },
		{ name: 'Eggs', quantity: 1, unit: 'carton', department: 'Dairy', recipeIds: ['recipe-1'], purchased: false, addedBy: 'system' },
	];
