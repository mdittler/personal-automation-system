...
export async function saveGroceryList(store: ScopedDataStore, list: GroceryList): Promise<void> {
	...
	const fm = generateFrontmatter({
		title: 'Grocery List',
		date: list.createdAt,
		tags: buildAppTags('hearthstone', 'grocery'),
		app: 'hearthstone',
	});
...
export async function archivePurchased(
	...
	const fm = generateFrontmatter({
		...
		date: isoNow(),
		tags: buildAppTags('hearthstone', 'grocery-history'),
		app: 'hearthstone',
	});
 ...
 */
export function buildGroceryButtons(list: GroceryList, appId = 'hearthstone'): InlineButton[][] {
