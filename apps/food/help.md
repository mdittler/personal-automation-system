# Food — Household Food Management
...
### Saving Recipes
Just paste or describe a recipe and Food will parse and save it:
...
Ask "what can I make?" and Food cross-references your pantry against your recipe library:
...
Send a photo to Food and it will automatically detect what it is:
...
- Food extracts the full recipe (ingredients, instructions, servings, etc.)
...
- Food extracts the store name, line items, and total
...
- Food identifies items and adds them to your pantry inventory
...
- If it's a recipe photo, Food offers to save the recipe too
...
Ask Food to adapt any recipe for your child:
...
Food tracks food costs from your grocery receipts and estimates meal costs.
