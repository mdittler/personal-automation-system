# Food User Requirements Specification
...
Declare broad food-related intent so general food queries route to Food rather than the default chatbot. Intent detection implemented via local regex patterns in Phase H1 (save, search, edit, food question intents).
